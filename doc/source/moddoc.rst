...
.. note::
    The material in this page is **not** part of ``YaPyCon``.

    It is built directly from the docstring of the ``yasara.py`` module by Elmar Krieger.

    ``yasara.py`` is included
    ...
    This page is generated by the docstring by re-formatting it (manually) to reStructured text and slightly editing it
    for better readability. It is included here as is because this information helps with the understanding of how
    YASARA's plugins work.
